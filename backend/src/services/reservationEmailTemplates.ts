...
export const RESERVATION_TEMPLATES = {
  CONFIRMATION: {
    ...
    html: (userName: string, bookTitle: string, queuePosition: number, expiresAt: Date) => `
  ...
  AVAILABLE: {
    ...
    html: (userName: string, bookTitle: string, expiresAt: Date) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px;">
  ...
  EXPIRED: {
    ...
    html: (userName: string, bookTitle: string) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px;">
