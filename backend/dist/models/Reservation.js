...
const reservationSchema = new mongoose_1.Schema({
    ...
    status: { type: String, enum: ['Pending', 'Fulfilled', 'Cancelled', 'Expired', 'Rejected'], default: 'Pending' },
    expiresAt: { type: Date },
    rejectionReason: { type: String, trim: true, maxlength: [300, 'Lý do từ chối không được vượt quá 300 ký tự'] },
    rejectedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', index: true },
}, { timestamps: true });
